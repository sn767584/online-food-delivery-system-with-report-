        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/kisspng-take-out.png" alt="logo" style="width:40px;height:40px;"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><?php echo 'WELCOME ,TO THE PAYMENT PAGE!!!'?></a>
                        </li>
                    </ul>						
                </div>
            </nav>
...
<!-- //////////////////////////////////////////////////////////////////////////// -->
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span class="right"> <a class="grey-text text-lighten-4" href="#">Ordering A Food Now Became An Easier Job!!!</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
    ...
    $("#formValidate").validate({
	  ...
	  $('#cvv_number').formatter({
		...
		if ($(this).val() === 'Wallet'){
		  $("#cc_number").prop('enabled', true);
		  $("#cvv_number").prop('enabled', true);	
		}
		});
    </script>
</body>
