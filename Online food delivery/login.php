...
<head>
  ...
  <style>
  .cyan{
    background:url("images/hamburger-and-fries.jpg") center;
  }
   </style>
...
<span class="page-center">  <a class="grey-text text-lighten-4" href="#">Ordering A Food Now Became An Easier Job!!!</a></span>
